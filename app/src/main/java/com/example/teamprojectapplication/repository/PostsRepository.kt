...
class PostsRepository() {
    ...
    fun bringEmail(postKey: String, callback: (String?) -> Unit)  {
        val postRef2 = FirebaseDatabase.getInstance().reference.child("post").child(postKey)
        postRef2.child("email").addListenerForSingleValueEvent(object: ValueEventListener{
    ...
    fun bringText(postKey: String, callback: (String?) -> Unit)  {
        val postRef2 = FirebaseDatabase.getInstance().reference.child("post").child(postKey)
        postRef2.child("text").addListenerForSingleValueEvent(object: ValueEventListener{
            override fun onDataChange(dataSnapshot: DataSnapshot) {
